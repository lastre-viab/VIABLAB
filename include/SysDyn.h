...
public:
  ...
  double (*lFunc_tych_fd)(unsigned long long int *x, unsigned long long int *u, unsigned long long int *v);
  ...
  void (*scaleInv) ( const double *x, double *res);
  double (*fScaleInvComponent)( const double x, int i);

  double  (*fTimeScaleInv)( const double  x );
  bool toScale;
  int getFDDynType();
