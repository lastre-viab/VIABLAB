...
public:
  ...
  void  setPoint(unsigned long long int posX, unsigned long long int posTrame, bool val);
  ...
  boost::dynamic_bitset<>   analyseTrameMasqueBis( unsigned long long int posX, bool print);
...
private:
   ...
   */
  inline void numToIntCoords_dm1(unsigned long long int num,unsigned long long int *res);
  inline void  numToSubGridCoords(unsigned long long int num,unsigned long long int *res);
   ...
   *  en argument � cette fonction
   */
  void numToIntAndDoubleCoords_dm1(unsigned long long int num,unsigned long long int *resI, double * resD);
   ...
   *   \f]
   */
  void intCoordsToNum_dm1( unsigned long long int * coords, unsigned long long int * res);
  /*!
