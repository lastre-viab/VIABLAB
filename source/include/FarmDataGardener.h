...
public:
	...
	double getCycleMaxDeficitWithAnnexe(unsigned long long int In, unsigned long long int t, unsigned long long int un);
    ...
    double getMinCycleBalanceForGivenPeriod(unsigned long long int In, unsigned long long int gamma, unsigned long long int nbMonths);
    double getCycleBalanceWithPricePerturbForGivenPeriod(unsigned long long int In,
    		unsigned long long int mStart, unsigned long long int mEnd, unsigned long long int un, double v);
    double getCyclePerturbedBalance(unsigned long long int In,
    		unsigned long long int t, unsigned long long int un, double v);
	...
	int  getNbParcels();
	double getIbqsLevelForSavings();
	double getAnnexCycleBalance(unsigned long long m,  unsigned long long int end);
...
private :
	...
	double IBQS_min;
	double IBQS_max;
	double IBQS_level_first_parcel;
	double IBQS_target;
	double *surfaces;
	int nbParcels;
	double deficitMax;
	...
	double annexInitIbqs;
	double annexSurface;
	double annexCoutFixe;
	CycleData * annexCycle;
	double * annexCycleBalance;
	bool farmWithAnnexSurface;
