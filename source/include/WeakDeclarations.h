...
__attribute__((weak)) double constraintsXU_fd( unsigned long long int * x, unsigned long long int * u ) ;
...
double  controlEligibilityForTraj_fd( unsigned long long int * x, unsigned long long int * u ,unsigned long long int * previousU) __attribute__((weak));
...
double l_tych_fd(unsigned long long int  * x, unsigned long long int * u, unsigned long long int * v )  __attribute__((weak));
...
inline double l_fd_tych_default(unsigned long long int  * x, unsigned long long int * u, unsigned long long int * v )
{
	return 0.0;
}

inline double  controlEligibilityForTraj_fd_default( unsigned long long int * x, unsigned long long int * u ,unsigned long long int * previousU)
{
	return 1.0;
}
