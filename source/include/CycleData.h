...
public:
	...
	double calculDeltaBilanMoisCycle(unsigned long long int m, double initI, double v);
	double calculDeltaBilanCycleSingleCrop(double I,int t, int T, double v);
	double calculDeltaBilanCycleMixedCrop(double initI,int t, int T, double v);
	double calculDeltaBilanCycle(double I,int t, int T, double v);
	double calculDeltaBilanMoisMixte(double Ilong, double Ishort, unsigned long long int mLong, unsigned long long int mShort, CropData * shortCrop, double v);
