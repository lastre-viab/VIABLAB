...
int main(int argc, char **argv) {
	...
	auto file_sink = std::make_shared<spdlog::sinks::basic_file_sink_mt>("../LOG/test.log", true);
	...
	spdlog::set_default_logger(std::make_shared<spdlog::logger>("ViabLog", spdlog::sinks_init_list({console_sink, file_sink})));
	...
	else { // on charge dans la mémoire l'ensemble calculé et enregistré
