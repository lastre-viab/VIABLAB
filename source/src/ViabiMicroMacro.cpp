...
{
	if(computeTmin)
		return  trajectoryHelper->computeOptimalTrajectory_tmin(initPosition,  fileName, succes);
	else
		return trajectoryHelper->computeOptimalTrajectory_Lmin(initPosition,  fileName, succes);
}
