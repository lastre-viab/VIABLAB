...
double STATE_MIN[dim]={-6.0, -2.5,0.0};

/*! \var STATE_MAX[dim]
 *  \brief max values  for  state vector components
 *   \see gridParams
 */
double STATE_MAX[dim]={1.0, 2.5, T};
 ...
 * \see gridParams
 */
unsigned long long int nbPointsState[dim]    =  {101, 101, 51};
...
unsigned long long int projection[dim]={0,0,1};

int sortieOKinf[dim]={0, 0,0};
int sortieOKsup[dim]={0,0,0};
